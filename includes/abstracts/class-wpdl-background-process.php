...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
	include_once dirname( WPDL_PLUGIN_FILE ) . '/includes/libraries/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
	include_once dirname( WPDL_PLUGIN_FILE ) . '/includes/libraries/wp-background-process.php';
}

/**
 * WPDL_Background_Process class.
 */
abstract class WPDL_Background_Process extends WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			...
			'display'  => sprintf( esc_html__( 'Every %d minutes', 'wp-desklite' ), $interval ),
		);
	 ...
	 * Delete all batches.
	 *
	 * @return WPDL_Background_Process
	 */
