...
if ( ! class_exists( 'WPDL_Background_Process', false ) ) {
	include_once dirname( __FILE__ ) . '/abstracts/class-wpdl-background-process.php';
}

/**
 * WPDL_Background_Emailer Class.
 */
class WPDL_Background_Emailer extends WPDL_Background_Process {
	...
	protected function task( $callback ) {
		if ( isset( $callback['filter'], $callback['args'] ) ) {
			try {
				WPDL_Emails::send_queued_transactional_email( $callback['filter'], $callback['args'] );
			} catch ( Exception $e ) {
